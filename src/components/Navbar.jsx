    ...
    <div>
      <nav className="nav_container">
        <div className="navbar_div">
          <Link to="#" className="navbar_link navbar_anker">
            <div className="logo_wrapper logo_container">
              <img
            ...
            <li>
              <div className="list_button_container">
                <div className="list_button_div">
                  <button className="list_button">Get Started</button>
                </div>
              </div>
            </li>
            <li></li>
